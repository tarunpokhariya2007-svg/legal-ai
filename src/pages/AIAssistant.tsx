...
export default function AIAssistant() {
  ...
  const startBrowserRecognition = () => {
    ...
    if (!SpeechRecognitionCtor) {
      alert(
        'Your browser does not support built-in speech recognition. Try Chrome, or switch to the Sarvam AI engine.'
      )
      return
    }
  ...
  // Sarvam path: records audio and sends it to backend
  ...
  const transcribeAudio = async (
    ...
    try {
      ...
      alert(
        'Voice input failed — could not reach the server. Check that the backend is running on port 5001.'
      )
  ...
  const handleSpeak = async (
    ...
    try {
      ...
      alert(
        'Voice output failed — could not reach the server. Check that the backend is running on port 5001.'
      )
              ...
              setMessages([
                {
                  ...
                  role: 'ai',
                  content:
                    'New conversation started. How can I help you with your legal matter today?',
                  timestamp:
                ...
                setMessages([
                  {
                    ...
                    role: 'ai',
                    content:
                      'Conversation cleared. How can I assist you today?',
                    timestamp:
                      new Date().toLocaleTimeString(
                        [],
                        {
