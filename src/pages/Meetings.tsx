...
function getMeetingState(start: string, end: string) {
  ...
  if (now < joinTime) {
    ...
    return {
      type: 'upcoming',
      label: `Join available in ${minutes} minute${minutes === 1 ? '' : 's'}`,
    };
  }
...
export default function Meetings() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(loadMeetings, 60 * 1000);
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: '#b5b5b5' }}>
                Your video consultations with advocates
              </p>
            </div>
          </div>
        </div>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="mt-4 text-sm" style={{ color: '#b5b5b5' }}>
        ...
        {!loading && !error && meetings.length === 0 && (
          ...
          >
            ...
            >
              <Video size={28} style={{ color: '#d4af37' }} />
            </div>
            ...
            <p
              ...
              style={{ color: '#b5b5b5' }}
            >
              Once an advocate accepts your video consultation
              request, your meeting will appear here.
            </p>
          </div>
        )}
        ...
        {!loading && !error && meetings.length > 0 && (
          <div className="space-y-5">
            {meetings.map((meeting) => {
              ...
              const advocateName =
                meeting.advocate_name ||
                meeting.lawyer_name ||
                'Advocate';

              const canJoin =
                meetingState.type === 'live' ||
                meetingState.type === 'upcoming';
                  ...
                  <div className="p-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium">
                            ...
                            {formatTime(meeting.scheduled_end)}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mt-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div>
                          ...
                          {meetingState.type === 'upcoming' && (
                            <p
                              ...
                              style={{ color: '#777' }}
                            >
                              You can join up to 10 minutes before
                      ...
                      {meetingState.type === 'live' && (
                        <button
                          onClick={() =>
                            joinMeeting(meeting.appointment_id)
                          }
